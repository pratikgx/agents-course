...
> [!TIP]
> Familiarisez-vous avec les chargeurs de données <a href="https://docs.llamaindex.ai/en/stable/module_guides/loading/connector/">LlamaHub</a> et le <i>parser</i> <a href="https://developers.llamaindex.ai/llamaparse/parse/getting_started/">LlamaParse</a> pour des sources de données plus complexes.
