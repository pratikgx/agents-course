...
<Tip>더 복잡한 데이터 소스를 위해 <a href="https://docs.llamaindex.ai/en/stable/module_guides/loading/connector/">LlamaHub</a> 로더와 <a href="https://developers.llamaindex.ai/llamaparse/parse/getting_started/">LlamaParse</a> 파서에 익숙해지세요.</Tip>
