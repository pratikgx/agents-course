...
> [!TIP]
> 对于复杂数据源，建议深入了解 <a href="https://docs.llamaindex.ai/en/stable/module_guides/loading/connector/">LlamaHub</a> 加载器和 <a href="https://developers.llamaindex.ai/llamaparse/parse/getting_started/">LlamaParse</a> 解析器的使用方法。
