...
> [!TIP]
> Get familiar with <a href="https://docs.llamaindex.ai/en/stable/module_guides/loading/connector/">LlamaHub</a> loaders and <a href="https://developers.llamaindex.ai/llamaparse/parse/getting_started/">LlamaParse</a> parser for more complex data sources.
